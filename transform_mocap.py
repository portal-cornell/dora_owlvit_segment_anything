...
cam2tag_transform = {
	"translation": [ 0.13276467, -0.55627471, 1.62005794],
	"rotation": [[-0.58219242, -0.81297795,  0.01090128],
 [ 0.38044374, -0.28424511, -0.88003823],
 [ 0.71855031, -0.50820426,  0.47477772]]}
...
if __name__ == '__main__':
	rospy.init_node('mocap_to_world_transform1')
	broadcaster = tf2_ros.StaticTransformBroadcaster()
	cam2tag = geometry_msgs.msg.TransformStamped()

	cam2tag.header.stamp = rospy.Time.now()
	cam2tag.header.frame_id = "cam_2_color_optical_frame"
