...
python multi_stream.py --video_path table_left.MOV --text_prompt="ketchup,blue tartar bottle,black pot,ladle" -o video_outputs_left/ --device cuda --get_topk --view=right
